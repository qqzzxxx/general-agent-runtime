"""One-time, allowlisted Fix 02 deployment; evidence stays outside dogfood."""
import hashlib
import json
import os
...
FILES = ['scripts/supervisor_control.py']
...
if mode == 'snapshot':
    ...
    tested = json.loads((SOURCE / 'evidence/dogfood-fix-02/test-results.json').read_text())['final_source_sha256']
    ...
    for relative in FILES:
        ...
        temp = target.with_suffix('.fix02.tmp')
